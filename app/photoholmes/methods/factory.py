...
from ..base import BasePhotoHolmesMethod as BaseMethod
    ...
    def load(
        ...
        match method_name:
            ...
            case MethodRegistry.TRUFOR:
                from .trufor import TruFor, trufor_preprocessing

                return TruFor.from_config(config), trufor_preprocessing
            case MethodRegistry.ZERO:
                from .zero import Zero, zero_preprocessing
