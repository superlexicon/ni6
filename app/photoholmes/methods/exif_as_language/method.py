...
from ...base import BasePhotoHolmesMethod, BenchmarkOutput
...
from ...utils.patched_image import PatchedImage
from ...utils.pca import PCA


class EXIFAsLanguage(BasePhotoHolmesMethod):
    """
    ...
    def __init__(
        ...
        # Base class already handles device assignment
    ...
    def predict(self, image: Union[str, np.ndarray, Image.Image]) -> Dict[str, Any]:
        ...
        return {
            'detection_score': float(getattr(result, 'detection', 0.0) if torch.is_tensor(getattr(result, 'detection', 0.0)) else getattr(result, 'detection', 0.0)),
